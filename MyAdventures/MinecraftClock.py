...
while True:
    ...
    hourHandAngle = (360 / 12) * hours + (360 / 60 / 12.0) * minutes
    #print hourHandAngle, minutes
    ...
    mcdrawing.drawLine(clockMiddle.x, clockMiddle.y, clockMiddle.z - 1, minHandX, minHandY, clockMiddle.z - 1, block.AIR.id)
